...
#Generating Random Password for wacd RPC
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status WAC.service${NC}"
 echo -e "================================================================================================================================"
}
